...
I am an Assistant Professor in Mechanical Engineering at IIT Gandhinagar. My research is focused on creating new smart materials and structures that can synergistically integrate with rapidly evolving digital electronics and power the next generation of robotic devices.

I was a Postdoctoral researcher in the [Wave Propagation and Metamaterials Laboratory](https://matlack.mechanical.illinois.edu/) at UIUC, working with [Prof. Kathryn Matlack](https://scholar.google.com/citations?user=JX7S9ZwAAAAJ&hl=en&oi=ao). My research investigated the interaction of different fluid flows with phononic materials (e.g., phononic crystals, metamaterials) whose devised material architecture customizes the fluid-structure coupling and enables control of the flow characteristics, e.g., laminar-to-turbulent transition, turbulent drag reduction, flow separation. 
